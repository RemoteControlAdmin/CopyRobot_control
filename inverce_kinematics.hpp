...
namespace robotkinematics {
    ...
    Eigen::Matrix3d invmatrix_cal(Eigen::Matrix3d inverse);

    Eigen::Vector3d invwheel_velocity_cal(Eigen::Matrix3d inverse_trans, Eigen::Vector3d velocity_data, Eigen::Vector3d invrobotvelocity);
